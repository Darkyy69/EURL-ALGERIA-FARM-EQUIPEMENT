        ...
        <div>
          ...
          <div className="bg-gray-800 p-4 rounded-lg shadow-md">
            <p className="italic mb-4">
              {footerContent[0]?.content?.testimonial || "Testimonial text here..."}
            </p>
        ...
        <div>
          ...
          <div className="space-y-4">
            {footerContent[1]?.content?.map((location, index) => (
              <div key={index}>
                <p className="font-semibold">{location.title || "Location Title"}</p>
                <p className="text-sm text-gray-400">{location.details || "Details not found"}</p>
                {location.contact && (
